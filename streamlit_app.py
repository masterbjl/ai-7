...
# 모델 로드
# ======================
FILE_ID = st.secrets.get("1cdbz-r9kShjyDwG8fujdaDUpwc_RObq7")
...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
    ...
    # },
  labels[0] : {"text" : ["중국식 냉면 냠냠"], "images" : ["https://www.esquirekorea.co.kr/resources_old/online/org_online_image/eq/71c93efd-352d-4fb4-8a98-dd1b51475442.jpg"]}
  labels[1] : {"text" : ["짜장면 냠냠"], "images" : ["https://img-cf.kurly.com/hdims/resize/%3E720x/quality/90/src/shop/data/goodsview/20230628/gv00000707399_1.jpg"]}
  labels[2] : {"text" : ["짬뽕 냠냠"], "images" : ["https://recipe1.ezmember.co.kr/cache/recipe/2020/11/28/2c2544a9719cccc3a794efe4ca994cd51.jpg"]}
  labels[3] : {"text" : ["탕수육 냠냠"], "images" : ["https://homecuisine.co.kr/files/attach/images/142/073/002/3419c948fb2f0c2a96b0bc49afd75947.JPG"]}
